						...
						<div class="row">
							<div class="col-lgs-3 col-xs-6 status-idm-kiri">
								<div class="small-box bg-primary">
									...
									<div class="icon">
										<i class="fad fa-chart-line" style="color: #000"></i>
									</div>
								</div>
							</div>
							<div class="col-lgs-3 col-xs-6 status-idm-kiri status-idm-kanan">
								<div class="small-box bg-warning">
									...
									<div class="icon">
										<i class="fad fa-wave-pulse" style="color: #000"></i>
									</div>
								</div>
							</div>
							<div class="col-lgs-3 col-xs-6 status-idm-kiri status-idm-kanan">
								<div class="small-box bg-success">
									...
									<div class="icon">
										<i class="fad fa-chart-column" style="color: #000"></i>
									</div>
								</div>
							</div>
							<div class="col-lgs-3 col-xs-6 status-idm-kanan">
								<div class="small-box bg-danger">
									...
									<div class="icon">
										<i class="fad fa-chart-pie" style="color: #000"></i>
									</div>
								</div>
							</div>
						</div>
