	...
	<div class="box-body">
		...
		<div id="container" align="center">
			<table cellpadding="0" cellspacing="0" class="counter">
				<tr>
					<td>Hari ini</td>
					<td style="background-color: #1eb753; color: white ;border-radius:  5px 5px 0px 0px;"><?= $today; ?></td>
				</tr>
				<tr>
					<td valign="middle" height="20">Kemarin </td>
					<td valign="middle" style="background-color: #4a5568; color: white"><?= $yesterday; ?></td>
				</tr>
				<tr>
					<td valign="middle" height="20">Jumlah pengunjung</td>
					<td valign="middle" style="background-color: #c840b9; color: white; border-radius: 0px 0px 5px 5px;"><?= $total; ?></td>
				</tr>
